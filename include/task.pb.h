...
class TaskPlanReply : public ::google::protobuf::Message {
 public:
  ...
  inline ::machinetalk::ContainerType cmd() const;
  inline void set_cmd(::machinetalk::ContainerType value);
...
class TicketUpdate : public ::google::protobuf::Message {
 public:
  ...
  inline ::machinetalk::RCS_STATUS status() const;
  inline void set_status(::machinetalk::RCS_STATUS value);
