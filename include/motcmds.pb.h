...
class MotionCommand : public ::google::protobuf::Message {
 public:
  ...
  inline ::machinetalk::cmd_code_t command() const;
  inline void set_command(::machinetalk::cmd_code_t value);
  ...
  inline const ::machinetalk::EmcPose& tool_offset() const;
  inline ::machinetalk::EmcPose* mutable_tool_offset();
  inline ::machinetalk::EmcPose* release_tool_offset();
  inline void set_allocated_tool_offset(::machinetalk::EmcPose* tool_offset);
...
class MotionStatus : public ::google::protobuf::Message {
 public:
  ...
  inline ::machinetalk::cmd_code_t commandecho() const;
  inline void set_commandecho(::machinetalk::cmd_code_t value);
  ...
  inline ::machinetalk::cmd_status_t commandstatus() const;
  inline void set_commandstatus(::machinetalk::cmd_status_t value);
  ...
  inline const ::machinetalk::EmcPose& carte_pos_fb() const;
  inline ::machinetalk::EmcPose* mutable_carte_pos_fb();
  inline ::machinetalk::EmcPose* release_carte_pos_fb();
  inline void set_allocated_carte_pos_fb(::machinetalk::EmcPose* carte_pos_fb);
...
inline ::machinetalk::EmcPose* MotionCommand::mutable_tool_offset() {
  set_has_tool_offset();
  if (tool_offset_ == NULL) tool_offset_ = new ::machinetalk::EmcPose;
...
inline ::machinetalk::EmcPose* MotionStatus::mutable_carte_pos_fb() {
  ...
  if (carte_pos_fb_ == NULL) carte_pos_fb_ = new ::machinetalk::EmcPose;
