...
#include "runtime/rtapi_bitops.h"     // rtapi_atomic_type
#include "runtime/rtapi_exception.h"  // thread status descriptors
#include "runtime/rtapi_heap.h"       // shared memory allocator
